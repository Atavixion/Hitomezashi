...
/* package hitomezashi-0.1.0.0 */
#ifndef VERSION_hitomezashi
#define VERSION_hitomezashi "0.1.0.0"
#endif /* VERSION_hitomezashi */
#ifndef MIN_VERSION_hitomezashi
#define MIN_VERSION_hitomezashi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hitomezashi-0.1.0.0-inplace-hitomezashi"
